    ...
    <section className='bg-background-alt dark:bg-background-dark-alt py-20'>
      <div className='mx-auto max-w-7xl px-4 sm:px-6 lg:px-8'>
        ...
        <div className='mx-auto max-w-2xl rounded-2xl bg-white dark:bg-background-dark p-6 sm:p-8 shadow-xl ring-1 ring-slate-900/5 dark:ring-white/10'>
          {/* Total Bill Input */}
          <div className='mb-8'>
            <label className='mb-2 block text-sm font-semibold text-text-main dark:text-white'>
              Monto Total del Recibo de Agua
            </label>
            <div className='relative rounded-lg shadow-sm'>
              <div className='pointer-events-none absolute inset-y-0 left-0 flex items-center pl-4'>
                <span className='text-text-muted sm:text-lg'>$</span>
              </div>
              <input
              ...
              <div className='pointer-events-none absolute inset-y-0 right-0 flex items-center pr-4'>
                <span className='text-text-muted sm:text-sm'>MXN</span>
              </div>
            </div>
          </div>
          ...
          <div className='mt-8 border-t border-slate-100 dark:border-slate-800 pt-6'>
            <button className='w-full rounded-lg bg-text-main dark:bg-white py-3 text-center text-sm font-bold text-white dark:text-background-dark transition-all hover:bg-black/80 dark:hover:bg-slate-200'>
